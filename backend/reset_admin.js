...
const resetAdmin = async () => {
    ...
    try {
        ...
        if (res.rows.length > 0) {
            ...
            await pool.query(
                'INSERT INTO users (id, name, username, password, role, "createdAt", "updatedAt") VALUES ($1, $2, $3, $4, $5, $6, $7)',
                [require('crypto').randomUUID(), 'X-ICON Manager', 'xicongarage', hashedPassword, 'ADMIN', new Date(), new Date()]
            );
