...
const ASSISTANT_KNOWLEDGE = [
    ...
    // Services
    {
        keywords: ['service', 'offer', 'capabilities'],
...
const testCases = [
    ...
    { query: "How do I pay?", expected: "We accept Cash" }, 
    { query: "Do you sell tires?", expected: "For most sedans" }, 
...
testCases.forEach(({ query, expected }) => {
    // console.log(`\nQuery: "${query}"`);
    const response = generateResponseSimple(query); 
